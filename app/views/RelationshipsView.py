...
class RelationshipsView:
    ...
    def drawRelationshipSymbol(self, painter, start: QPoint, end: QPoint, rel_type: str):
        ...
        offset_distance = 12  # przesunięcie symbolu od krawędzi
        ...
        if rel_type is RelationshipsEnum.REL_1_1:
            ...
            draw_crows_foot(offset_point(start, angle, -offset_distance), flip=True)  # ← odwrócone
            draw_crows_foot(offset_point(end, angle, offset_distance))  # ← normalne
    ...
    def edgePoint2(self, start_rect, end_pos):
        ...
        # Obsługa przypadku, gdy end_pos to QPoint (czyli kursor)
