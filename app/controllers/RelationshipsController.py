...
class RelationshipsController(ConnectionsController):
    ...
    def displayRelationshipContextMenu(self, cursorPosition, globalCursorPosition):
        ...
        if ObtainedRelationship is not None:
            ...
            if self.__RelationshipContextMenuController.getSelectEditRelationshipStatus():
                self.__RelationshipContextMenuController.unselectEditRelationship()
                self.__isContextMenuAtWork = False
                return RelationshipContextMenuEnum.EDIT
            elif self.__RelationshipContextMenuController.getSelectDeleteRelationshipStatus():
