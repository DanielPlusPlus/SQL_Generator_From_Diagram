...
class InheritancesController(ConnectionsController):
    ...
    def editInheritance(self, cursorPosition):  # deprecated
        print("edit")
    ...
    def displayInheritanceContextMenu(self, cursorPosition, globalCursorPosition):
        ...
        if ObtainedRelationship is not None:
            ...
            if self.__InheritanceContextMenuController.getSelectEditInheritanceStatus():
                self.__InheritanceContextMenuController.unselectEditInheritance()
                self.__isContextMenuAtWork = False
                return InheritanceContextMenuEnum.EDIT
            elif self.__InheritanceContextMenuController.getSelectDeleteInheritanceStatus():
